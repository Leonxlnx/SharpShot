...
namespace SharpShot
{
    ...
    internal sealed class SharpShotContext : ApplicationContext
    {
        ...
        internal SharpShotContext(bool silentStartup)
        {
            ...
            ToolStripMenuItem aboutItem = new ToolStripMenuItem("About SharpShot Quick");
            ...
            _tray.Text = "SharpShot Quick - Win+Shift+D capture, Win+Shift+A record";
    ...
    internal static class SelfTest
    {
        internal static int Run(string outputFolder, bool includeLiveCapture)
        {
            ...
            try
            {
                ...
                report.Add("PASS: recording source-to-output policy is deterministic");
        ...
        private static void VerifyRecordingPolicy(string outputFolder)
        {
            ...
            RecordingCursorPolicy visibleCursor = new RecordingCursorPolicy(true, false);
            if (!visibleCursor.IncludeInVideo || visibleCursor.CaptureEditableMetadata)
                throw new InvalidOperationException("Quick recording cursor policy changed.");
        }
